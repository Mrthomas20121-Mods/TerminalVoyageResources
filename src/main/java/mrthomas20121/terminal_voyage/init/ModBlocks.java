...
public class ModBlocks {
    ...
    public static final Pair<RegistryObject<Block>, RegistryObject<Item>> STRANGE_AQUAMARINE_SHALE_ORE = registerSandBlock("strange_aquamarine_shale_ore", 0xD5B791);
    public static final Pair<RegistryObject<Block>, RegistryObject<Item>> CRYSTAL_AQUAMARINE_SHALE_ORE = registerSandBlock("crystal_aquamarine_shale_ore", 16777215);
    public static final Pair<RegistryObject<Block>, RegistryObject<Item>> MIDNIGHT_AQUAMARINE_SHALE_ORE = registerSandBlock("midnight_aquamarine_shale_ore", 3553084);
    ...
    private static Pair<RegistryObject<Block>, RegistryObject<Item>> registerSandBlock(String name, int color) {
        return register(name, new SandBlock(color, AbstractBlock.Properties.of(Material.SAND).sound(SoundType.SAND).requiresCorrectToolForDrops().harvestTool(ToolType.SHOVEL).strength(2.0F, 2.0F)));
    }
